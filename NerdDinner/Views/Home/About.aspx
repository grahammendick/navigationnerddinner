...
<asp:Content ID="Main" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <p>
         ...
         <p>We're free and fun. <asp:HyperLink ID="FindLink" runat="server" Text="Find a dinner near you" />, or <asp:HyperLink ID="CreateLink" runat="server" Text="host a dinner" />. Be social.</p>
