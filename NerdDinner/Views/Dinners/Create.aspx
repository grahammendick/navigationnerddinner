<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Create.aspx.cs" Inherits="NerdDinner.Views.Dinners.Create" MasterPageFile="~/Views/Shared/Site.Master" Theme="Site" %>
...
<asp:Content ID="Main" ContentPlaceHolderID="MainContent" runat="server">
	...
	<asp:FormView ID="CreateForm" runat="server" DataSourceID="DinnerDataSource" DefaultMode="Edit">
		<EditItemTemplate>
			<fieldset>
				<div id="dinnerDiv">
				<p>
	...
	<asp:ObjectDataSource ID="DinnerDataSource" runat="server" SelectMethod="GetCreate" TypeName="NerdDinner.Controllers.DinnersController" DataObjectTypeName="NerdDinner.Models.Dinner" UpdateMethod="Create">
		<UpdateParameters>
